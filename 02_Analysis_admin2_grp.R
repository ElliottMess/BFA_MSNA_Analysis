...
summary_stats_admin_2_final_grp <- format_results(cleaned_data_adm2, final_result_admin_2_grp, aggregate_level = "admin2", pop_grp = "status", weights = "weights_sampling", csv = TRUE, questionnaire = questionnaire)
