...
summary_stats_admin_0_hrp_admin1 <- format_results(cleaned_data_adm1, final_result_admin_0_hrp_admin1, aggregate_level = "admin0", weights = "weights_sampling", csv = TRUE)
