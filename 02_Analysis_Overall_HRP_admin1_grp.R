...
analysisplan_admin_0_grp <- make_analysis_plan_template(df= cleaned_data_adm1_hrp,
...
final_result_admin_0_hrp_admin1_grp <- from_analysisplan_map_to_output(data = cleaned_data_adm1_hrp,
...
summary_stats_admin_0_hrp_admin1_grp_final <- format_results(cleaned_data_adm1_hrp, final_result_admin_0_hrp_admin1_grp,
